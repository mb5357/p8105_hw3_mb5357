...
zip_counts |>
  summarize(
    ...
    very_sparse = sum(n_obs < 10)
  )

```

Out of all ZIP codes, 149 are observed in all 116 months between Jan 2015 and Aug 2024.
Zero ZIP codes have fewer than 10 observations.
ZIPs with full coverage likely represent stable residential areas. Others may be missing data due to low activity, data gaps, or newer ZIP codes.
